...
<article>
    ...
    <form action="/form/send?id=web-estimate" method="post" id="plugin_form" class="validate">
        ...
        <p id="fixedBox" class="price fixed"><span id="plugin_form_price">430,000</span>円（税別）
        </p>
        ...
        <!-- 必須料金 -->
        <dl>
            <dt class="tooltip_hide">HP制作基本料金
                <i class="fa-solid fa-question" ontouchstart="">
            ...
            <dd><select name="plugin_form[server]" disabled="disabled" class="validate[required]">
                    <option value="必要">必須（30,000円）</option>
                </select>
                <input type="hidden" name="plugin_form[__label][server]" value="サーバー初期設定費用 ">
                <input type="hidden" name="plugin_form[__price][server][必要]" value="30000">
                <input type="hidden" name="plugin_form[__price][server]" value="30000">
                <input type="hidden" name="plugin_form[server]" value="30,000円">
            </dd>
        </dl>
        <hr />
        <h2 style="margin-bottom: 2rem;">追加オプション</h2>

        <!--　以後 追加料金 -->
        <dl>
            <dt class="tooltip_hide">追加トップページデザイン提案
                <i class="fa-solid fa-question" ontouchstart="">
            ...
            <dd>
                <select name="plugin_form[cms]">
                    ...
                    <option value="必要 50,000円" data-price="50000">必要（50,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[freo]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="1個所 50,000円" data-price="50000">1個所（50,000円）</option>
                    <option value="2個所 100,000円" data-price="100000">2個所（100,000円）</option>
                    <option value="3個所 150,000円" data-price="150000">3個所（150,000円）</option>
                    <option value="4個所 200,000円" data-price="200000">4個所（200,000円）</option>
                    <option value="5個所 250,000円" data-price="250000">5個所（250,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[docu]">
                    ...
                    <option value="1ページ 40,000円" data-price="40000">1ページ（40,000円）</option>
                    <option value="2ページ 80,000円" data-price="80000">2ページ（80,000円）</option>
                    <option value="3ページ 120,000円" data-price="120000">3ページ（120,000円）</option>
                    <option value="4ページ 160,000円" data-price="160000">4ページ（160,000円）</option>
                    <option value="5ページ 200,000円" data-price="200000">5ページ（200,000円）</option>
                    <option value="6ページ 240,000円" data-price="240000">6ページ（240,000円）</option>
                    <option value="7ページ 280,000円" data-price="280000">7ページ（280,000円）</option>
                    <option value="8ページ 320,000円" data-price="320000">8ページ（320,000円）</option>
                    <option value="9ページ 360,000円" data-price="360000">9ページ（360,000円）</option>
                    <option value="10ページ 400,000円" data-price="400000">10ページ（400,000円）</option>
                    <option value="15ページ 600,000円" data-price="600000">15ページ（600,000円）</option>
                    <option value="20ページ 800,000円" data-price="800000">20ページ（800,000円）</option>
                    <option value="25ページ 1,000,000円" data-price="1000000">25ページ（1,000,000円）</option>
                    <option value="30ページ 1,200,000円" data-price="1200000">30ページ（1,200,000円）</option>
            ...
            <dd>
                <select name="plugin_form[landing]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="1ページ 150,000円" data-price="150000">1ページ（150,000円)</option>
                    <option value="2ページ 300,000円" data-price="300000">2ページ（300,000円）</option>
                    <option value="3ページ 450,000円" data-price="450000">3ページ（450,000円）</option>
                    <option value="4ページ 600,000円" data-price="600000">4ページ（600,000円）</option>
                    <option value="5ページ 750,000円" data-price="750000">5ページ（750,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[contact]">
                    ...
                    <option value="バックメール・履歴保存機能付き 項目10個まで 50,000円" data-price="50000">バックメール・履歴保存機能 項目10個まで（50,000円）</option>
                    <option value="バックメール・履歴保存機能付き 項目20個まで 60,000円" data-price="60000">バックメール・履歴保存機能 項目20個まで（60,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[smart]">
                    ...
                    <option value="スマートフォンに対応する 100,000円" data-price="100000">スマートフォンに対応する（100,000円）</option>
                    <option value="スマートフォン&amp;タブレットに対応する 200,000円" data-price="200000">スマートフォン&amp;タブレットに対応する（200,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[responsive]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="1ページ 5,000円" data-price="5000">1ページ（5,000円）</option>
                    <option value="2ページ 10,000円" data-price="10000">2ページ（10,000円）</option>
                    <option value="3ページ 15,000円" data-price="15000">3ページ（15,000円）</option>
                    <option value="4ページ 20,000円" data-price="20000">4ページ（20,000円）</option>
                    <option value="5ページ 25,000円" data-price="25000">5ページ（25,000円）</option>
                    <option value="6ページ 30,000円" data-price="30000">6ページ（30,000円）</option>
                    <option value="7ページ 35,000円" data-price="35000">7ページ（35,000円）</option>
                    <option value="8ページ 40,000円" data-price="40000">8ページ（40,000円）</option>
                    <option value="9ページ 45,000円" data-price="45000">9ページ（45,000円）</option>
                    <option value="10ページ 50,000円" data-price="50000">10ページ（50,000円）</option>
                    <option value="15ページ 75,000円" data-price="75000">15ページ（75,000円）</option>
                    <option value="20ページ 100,000円" data-price="100000">20ページ（100,000円）</option>
                    <option value="25ページ 125,000円" data-price="125000">25ページ（125,000円）</option>
                    <option value="30ページ 150,000円" data-price="150000">30ページ（150,000円）</option>
                    <option value="35ページ 175,000円" data-price="175000">35ページ（175,000円）</option>
                    <option value="40ページ 200,000円" data-price="200000">40ページ（200,000円）</option>
                    <option value="45ページ 225,000円" data-price="225000">45ページ（225,000円）</option>
                    <option value="50ページ 250,000円" data-price="250000">50ページ（250,000円）</option>
                    <option value="100ページ 500,000円" data-price="500000">100ページ（500,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[photo]">
                    ...
                    <option value="撮影する（3時間）30,000円" data-price="30000">撮影する/3時間（30,000円）</option>
                    <option value="撮影する（6時間）45,000円" data-price="45000">撮影する/6時間（45,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[seo]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="対策する 150,000円" data-price="150000">対策する（150,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[writer]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="1ページ（ライター拘束x1）60,000円" data-price="60000">1ページ（ライター拘束x1）60,000円</option>
                    <option value="2ページ（ライター拘束x1）80,000円" data-price="80000">2ページ（ライター拘束x1）80,000円</option>
                    <option value="3ページ（ライター拘束x1）100,000円" data-price="100000">3ページ（ライター拘束x1）100,000円</option>
                    <option value="4ページ（ライター拘束x1）120,000円" data-price="120000">4ページ（ライター拘束x1）120,000円</option>
                    <option value="5ページ（ライター拘束x1）140,000円" data-price="140000">5ページ（ライター拘束x1）140,000円</option>
                    <option value="6ページ（ライター拘束x2）180,000円" data-price="180000">6ページ（ライター拘束x2）180,000円</option>
                    <option value="7ページ（ライター拘束x2）200,000円" data-price="200000">7ページ（ライター拘束x2）200,000円</option>
                    <option value="8ページ（ライター拘束x2）220,000円" data-price="220000">8ページ（ライター拘束x2）220,000円</option>
                    <option value="9ページ（ライター拘束x2）240,000円" data-price="240000">9ページ（ライター拘束x2）240,000円</option>
                    <option value="10ページ（ライター拘束x2）260,000円" data-price="260000">10ページ（ライター拘束x2）260,000円</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[logo]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="1案作成・修正2回まで 60,000円" data-price="60000">1案作成・修正2回まで 60,000円</option>
                    <option value="2案作成・修正2回まで 80,000円" data-price="80000">2案作成・修正2回まで 80,000円</option>
                    <option value="3案作成・修正2回まで 100,000円" data-price="100000">3案作成・修正2回まで 100,000円</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[googleb]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="依頼する 30,000円" data-price="30000">依頼する（30,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[domain]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="取得する 10,000円" data-price="10000">取得する（10,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[transfer]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="移管する 30,000円" data-price="30000">移管する（30,000円）</option>
                </select>
            ...
            <dd>
                <select name="plugin_form[ssl]">
                    <option value="">選択して下さい</option>
                    <option value="不要">不要</option>
                    <option value="簡易SSL 10,000円/初回のみ" data-price="10000">簡易SSL（10,000円/初回のみ）</option>
                    <option value="クイック認証SSL 30,000円/1年" data-price="30000">クイック認証SSL（30,000円/1年）</option>
                    <option value="企業認証SSL 90,000円/1年" data-price="90000">企業認証SSL（90,000円/1年）</option>
                    <option value="EV SSL 200,000円/1年" data-price="200000">EV SSL（200,000円/1年）</option>
                </select>
